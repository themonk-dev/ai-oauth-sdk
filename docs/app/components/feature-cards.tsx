      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
        {visible.map((feature) => (
          <Link
            key={feature.href}
            to={feature.href}
            className="group relative flex flex-col gap-3 rounded-xl border border-fd-border bg-fd-card p-4 shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:border-fd-primary/40 hover:shadow-md"
          >
            <div className="flex items-center justify-between">
              ...
              <RiArrowRightLine className="size-4 -translate-x-1 text-fd-muted-foreground opacity-0 transition-all duration-200 group-hover:translate-x-0 group-hover:text-fd-primary group-hover:opacity-100" />
            </div>
