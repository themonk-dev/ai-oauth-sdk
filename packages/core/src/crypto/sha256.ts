 ...
 *
 * This exists so PKCE `S256` challenges work on runtimes without WebCrypto's
 * `crypto.subtle` — most importantly React Native/Hermes, where `subtle` is
 * undefined unless the app installs a native polyfill. Keeping a fallback here
 * means consumers get working PKCE with zero extra dependencies.
 *
